    ...
    class classtest
    {
        public static async void Test()
        {
            DateTime MaDate = DateTime.Now;
                ...
                //string ChaineConnexion = "Provider=SQLOLEDB;Data Source=172.16.6.195;User ID=super; Password=xeonserver225; Initial Catalog=CREM";
                string ChaineConnexion = "Provider=SQLOLEDB;Data Source=192.168.0.208\\REPORT;User ID=sa; Password=saa; Initial Catalog=CREM";
                OleDbConnection conn = new OleDbConnection(ChaineConnexion);
                conn.Open();
                ...
                Command.CommandText = "SELECT distinct([code_client_1]), [identifiant_4],[type_id_5] FROM declarations where periode_dcl_2 = '202010' and type_f_3='" + type_f + "' order by [code_client_1]";
            ...
            iz = 0;
                ...
                MyWriter.WriteStartElement("s2");//debut s2 faire pour chaque client
                    ...
                    C2.CommandText = "SELECT * FROM declarations where periode_dcl_2='202010' and code_client_1=" + codeclt + " and type_f_3='" + type_f + "' order by num_dos_0";
                    C2.ExecuteNonQuery();
                ...
                iz = 0;
                    ...
                    MyWriter.WriteStartElement("s20");//debut s20 pour chaque credit
                        ...
                        C3.CommandText = "SELECT * FROM garanties where num_dos=" + numdos;
                        C3.ExecuteNonQuery();
...
/*
                CS.CommandText = "UPDATE declarations SET date_dcl_6 ='" + dtdcl + "' where num_file_32='xxxxx'";
                CS.ExecuteNonQuery();

                CS.CommandText = "UPDATE declarations SET periode_dcl_2 ='" + perioddcl + "' where num_file_32='xxxxx'";
                CS.ExecuteNonQuery();

                CS.CommandText = "UPDATE declarations SET num_file_32='" + nomfile + "' where num_file_32='xxxxx'";
                CS.ExecuteNonQuery();
